...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="https://github.com/Krishnaradha123" target="_blank" rel="noreferrer noopener">Malaya</a> </strong>{'Copyright ©'}
                    ...
                    <Grid container
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <Avatar sx={{ mt: 1, bgcolor: pink[500] }}>
                                    <LocationOnIcon />
                                </Avatar><span>AIIMS Bhubaneswar</span>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="mailto:pedamalaya@gmail.com">
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="www.linkedin.com/in/malaya-ranjan-peda-64775332b" target="_blank" rel="noopener noreferrer" >
                                    LinkedIn
                                </a>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://github.com/Krishnaradha123" target="_blank" rel="noopener noreferrer" >
                                    GitHub
                                </a>
                            </Stack >
